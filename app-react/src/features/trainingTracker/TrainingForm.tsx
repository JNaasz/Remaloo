...
import { SheetItem } from 'common/src/types/globals';
...
function TrainingForm({ onSubmit, onCancel }: TrainingFormProps) {
  ...
  const handleChange = (
    ...
    setFormData((prevData) => ({
      ...prevData,
      [name]: name === 'Duration' ? Number(value) : value, // need to convert duration to a number
    }));
  };
